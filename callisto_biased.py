...
plt.axvline(x = observation_times_cal/31536000, label = 'occ',color="magenta")
plt.ylim([10e2,10e4])
plt.yscale("log")
...
axs[0].plot(tc,alpha, label = 'RA', color = 'black')
axs[0].set_ylabel('Right Ascension [rad]')
axs[0].set_yscale("log")
axs[0].axvline(x = observation_times_cal/31536000,label = 'occ', color="magenta")
axs[0].legend()
axs[1].plot(time_cal/31536000,dec, label = 'Dec', color = 'black')
