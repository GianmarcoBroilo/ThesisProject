...
observation_settings_list = [observation.cartesian_position(link_ends_cal)]
...
covariance_matrix = np.savetxt("/Users/gianmarcobroilo/Desktop/ThesisResults/apriori/covariance_matrix_callisto_jup.dat",pod_output.covariance)
