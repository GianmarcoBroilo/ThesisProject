...
calendar_start = datetime.datetime(2023,10,1)
...
covariance_a_priori = np.block([
    [covariance_position_initial_cal, np.zeros((3,3)), np.zeros((3,3)),np.zeros((3,3)),np.zeros((3,2))],
    [np.zeros((3,3)),covariance_velocity_initial_cal, np.zeros((3,3)), np.zeros((3,3)),np.zeros((3,2))],
    [np.zeros((3,3)),np.zeros((3,3)),covariance_position_initial_jup, np.zeros((3,3)),np.zeros((3,2))],
    [np.zeros((3,3)),np.zeros((3,3)), np.zeros((3,3)), covariance_velocity_initial_jup,np.zeros((3,2))],
    [np.zeros((2, 3)), np.zeros((2, 3)), np.zeros((2, 3)), np.zeros((2, 3)), bias_jupiter]
])
...
initial_state = np.savetxt("/Users/gianmarcobroilo/Desktop/ThesisResults/VLBI/1-0.5/initial_state.dat",state_array)
uncertainty_cal = np.savetxt("/Users/gianmarcobroilo/Desktop/ThesisResults/VLBI/1-0.5/position/uncertainty_cal.dat",values_cal)
uncertainty_jup = np.savetxt("/Users/gianmarcobroilo/Desktop/ThesisResults/VLBI/1-0.5/position/uncertainty_jup.dat",values_jup)
time_prop = np.savetxt("/Users/gianmarcobroilo/Desktop/ThesisResults/VLBI/1-0.5/time_prop.dat",time_cal)
obs = np.savetxt("/Users/gianmarcobroilo/Desktop/ThesisResults/VLBI/1-0.5/observations_stellar.dat",observation_times_cal)
obs2 = np.savetxt("/Users/gianmarcobroilo/Desktop/ThesisResults/VLBI/1-0.5/observations_vlbi.dat",observation_times_jup)
