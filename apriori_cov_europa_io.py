...
observation_settings_list_io = observation.cartesian_position(link_ends_io)
observation_settings_list_europa = observation.cartesian_position(link_ends_europa)
...
# Add noise levels to Europa
noise_level_europa = 25e3
observation.add_gaussian_noise_to_settings(
    [observation_simulation_settings_europa],
    noise_level_europa,
    observation.position_observable_type
)
# Add noise levels to Jupiter
...
weights_io = noise_level_io ** -2
weights_europa = noise_level_europa ** -2
weights_jup = noise_level_jup ** -2
pod_input.set_constant_weight_for_observable_and_link_ends(observation.position_observable_type,link_ends_io,weights_io)
pod_input.set_constant_weight_for_observable_and_link_ends(observation.position_observable_type,link_ends_europa,weights_europa)
pod_input.set_constant_weight_for_observable_and_link_ends(observation.position_observable_type,link_ends_jup,weights_jup)
...
Export data  
"""
covariance_matrix = np.savetxt("/Users/gianmarcobroilo/Desktop/ThesisResults/apriori/output_covariance_matrix_europa_io.dat",pod_output.covariance)
